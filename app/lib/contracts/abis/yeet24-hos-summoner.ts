export const Yeet24HOSSummonerAbi = [
    {
      "inputs": [],
      "name": "Yeet24HOS__ParamSizeMismatch",
      "type": "error"
    },
    {
      "anonymous": false,
    ...
    {
      "inputs": [],
      "name": "baalVaultSummoner",
      "outputs": [
        {
          "internalType": "contract IBaalAndVaultSummoner",
          "name": "",
          "type": "address"
        }
      ],
    ...
    },
    {
      ...
      "name": "predictDeterministicShamanAddress",
      "outputs": [
        {
          "internalType": "address",
          "name": "predicted",
